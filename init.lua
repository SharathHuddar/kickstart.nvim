...
-- Keep cursor in the middle of the screen as we scroll
vim.o.scrolloff = 999
...
-- Ext terminal mode in the builtin terminal with a shortcut that is a bit easier
...
require('lazy').setup(
  {
    ...
    -- Been trying out git-blame. Hence, commented out gitsigns
    -- If git-blame.nvim is working out pretty well, delete gitsigns.nvim
    ...
    -- },
    {
      -- TODO: blame line does not refresh after committing. Even committed lines are showing up as uncommitted. Fix it
      -- Convo with GPT - https://chatgpt.com/g/g-p-691bfb79eb9c8191819a7976f80b2a80-neovim/c/69438a31-0e9c-8320-9326-cb67ea737470
    ...
    { -- Autoformat
      ...
      opts = {
        ...
        format_on_save = function(bufnr)
          ...
          -- enable for JS and TSX once you can get the right formatter running
